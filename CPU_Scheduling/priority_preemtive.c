 ...
 * In this preemptive version, the process can be stopped once it starts to execute, if another proccess has higher precedence.
 * The lower the value of the priority variable, higher the precedence.
